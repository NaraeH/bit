...
CREATE TABLE ORDERS (
	...
	QTY   INTEGER     NULL     COMMENT '주문수량', -- 주문수량
	ODATE DATE        NULL     COMMENT '주문일', -- 주문일
	PNO   INTEGER     NULL     COMMENT '제품번호', -- 제품번호
	UID   VARCHAR(20) NULL     COMMENT '아이디' -- 아이디
)
COMMENT '주문정보';
...
CREATE TABLE PRODUCTS (
	...
	QTY   INTEGER      NULL     COMMENT '잔여수량', -- 잔여수량
...
CREATE TABLE PROD_PHOTS (
	COL INTEGER      NOT NULL COMMENT '제품사진번호', -- 제품사진번호
	PNO INTEGER      NULL     COMMENT '제품번호', -- 제품번호
...
ALTER TABLE PROD_PHOTS
	MODIFY COLUMN COL INTEGER NOT NULL AUTO_INCREMENT COMMENT '제품사진번호';

-- 제조사
CREATE TABLE MAKERS (
	MKNO   INTEGER      NOT NULL COMMENT '제조사번호', -- 제조사번호
	MKNAME VARCHAR(80)  NULL     COMMENT '제조사', -- 제조사
...
CREATE TABLE MEMBERS (
	...
	PWD      VARCHAR(20)  NULL     COMMENT '암호', -- 암호
	EMAIL    VARCHAR(40)  NULL     COMMENT '이메일', -- 이메일
	UNAME    VARCHAR(80)  NULL     COMMENT '주문자명', -- 주문자명
