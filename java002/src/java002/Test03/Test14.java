...
public class Test14 {
  ...
  static ArrayList<Score14> list = new ArrayList<Score14>();
...
private static void save(){
  ...
  private static void doUpdate(int index) throws CloneNotSupportedException {
    ...
    Score14 score = list.get(index);
    Score14 tempScore = score.clone();
  ...
  private static void doAdd(String[] token) {
    Score14 score = new Score14(token[1], 
