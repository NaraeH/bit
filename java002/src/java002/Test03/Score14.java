 ...
 */
package java002.Test03;

import java.io.Serializable;

public class Score14 implements Serializable, Cloneable {
  ...
  public Score14(String name, int kor, int eng, int math) {
    this.name = name;
    this.kor = kor;
    this.eng = eng;
    this.math = math;
  ...
  @Override
	public Score14 clone() throws CloneNotSupportedException {
		return (Score14)super.clone();
	}
