...
public class ProductDao {
	...
	public Product selectOne(int no) {
		...
		try{
			return sqlSession.selectOne(
					"java002.test19.server.ProductDao.selectOne", no);
		}finally {
			sqlSession.close();
		}
	}
	...
	public List<Product> selectList(int pageNo, int pageSize) {
		...
		return sqlSession.selectList(
				"java002.test19.server.ProductDao.selectList",
				paramMap);
		}finally {
			sqlSession.close();
		}
	...
	public void insert(Product product){
		...
		try{
			sqlSession.insert(
					"java002.test19.server.ProductDao.insert", product);
			sqlSession.commit();
		}finally {
			sqlSession.close();
		}
	...
	public void update(Product product) {
		...
		try{
			sqlSession.update(
					"java002.test19.server.ProductDao.update", product);
			sqlSession.commit();
		}finally {
			sqlSession.close();
		}
	...
	public void delete(int no) {
		...
		try{
			sqlSession.delete(
					"java002.test19.server.ProductDao.delete", no);
			sqlSession.commit();
		}finally {
			sqlSession.close();
		}
