...
public class GameCenter {
	...
	private static int evaluate(String a, String b){
		switch(a){
		case Gamer.SCISSORS:
			if(b.equals(Gamer.PAPER)){
				return 1;
			}else if(b.equals(Gamer.ROCK)){
				return -1;
			}
			break;
		case Gamer.ROCK:
			if(b.equals(Gamer.SCISSORS)){
				return 1;
			}else if(b.equals(Gamer.PAPER)){
				return -1;
			}
			break;
		case Gamer.PAPER:
			if(b.equals(Gamer.ROCK)){
				return 1;
			}else if(b.equals(Gamer.SCISSORS)){
				return -1;
			}
		}
		return 0;
